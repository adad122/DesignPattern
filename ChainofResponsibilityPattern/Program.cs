...
namespace ChainofResponsibilityPattern
{
    ...
    public class DebugLogger : AbstractLogger
    {
        ...
        protected override void Write(string message)
        {
            Console.WriteLine("DebugLogger: " + message);
        }
    }
    ...
    class Program
    {
        ...
        {
            AbstractLogger consoleLogger = new ConsoleLogger(AbstractLogger.LOG_LEVEL_INFO);
            AbstractLogger debugLogger = new DebugLogger(AbstractLogger.LOG_LEVEL_DEBUG);
            AbstractLogger errorLogger = new ErrorLogger(AbstractLogger.LOG_LEVEL_ERROR);
